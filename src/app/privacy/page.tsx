      ...
      <section className="shell py-14 md:py-20">
        <div className="max-w-3xl">
          <div className="mb-10">
            ...
            <h1 className="headline h-hero mt-3">Privacy Policy</h1>
          </div>
          ...
          <div>
            <div>
              ...
              <div className="mb-8">
                <h2 className="headline h-sub mb-3">Summary</h2>
              ...
              <div className="copy space-y-8">
                <section>
                  <h2 className="headline h-sub mb-3">1. Who we are &amp; scope</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">2. Age</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">3. Data we collect</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">4. How we collect data</h2>
                  <ul className="space-y-2 list-disc pl-5">
                ...
                <section>
                  <h2 className="headline h-sub mb-3">5. How we use data</h2>
                  <ul className="space-y-2 list-disc pl-5">
                ...
                <section>
                  <h2 className="headline h-sub mb-3">6. Legal bases &amp; consent</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">7. Confidentiality &amp; security</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">8. Sharing your data</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">9. Organization/Team spaces</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">10. International transfers</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">11. Retention</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">12. Your choices &amp; rights</h2>
                  ...
                  <p>Use in-app tools or contact us at <a href="mailto:privacy@jeanihealth.com" className="text-accent underline transition-colors hover:text-cobalt">privacy@jeanihealth.com</a> to exercise these rights. You may also manage Organization connections, research invitations, and marketing preferences in Settings.</p>
                </section>

                <section>
                  <h2 className="headline h-sub mb-3">13. Cookies / SDKs / analytics</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">14. Third parties &amp; links</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">15. Changes to this Policy</h2>
                ...
                <section>
                  <h2 className="headline h-sub mb-3">16. Contact</h2>
                  <p>
                    Jeani Inc.<br />
