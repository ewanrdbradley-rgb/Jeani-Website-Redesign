      ...
      <section className="py-16 md:py-24 px-6 max-md:min-h-[100vh] pt-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-14 pt-8 text-center">
            <h1 className="t90 font-black text-4xl text-cobalt md:text-6xl">Terms &amp; Conditions</h1>
          </div>
          ...
          <div>
            <div>
              ...
              <div className="mb-8">
                <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-4">Overview</h2>
                <ul className="text-cobalt/80 space-y-2 list-disc pl-5">
                  ...
                  <li>You can export or delete your data as described in our <Link href="/privacy" className="text-accent underline hover:text-indigo">Privacy Policy</Link>.</li>
                </ul>
              </div>

              <div className="space-y-8 text-cobalt/80">
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">1. Who we are</h2>
                  <p>These Terms are between you and Jeani Inc., a Delaware corporation, 1702 Woodburn Rd, Durham, NC 27705 (&quot;Jeani,&quot; &quot;we,&quot; &quot;us&quot;). They govern your use of the Jeani mobile app, firmware, websites, dashboards, APIs, and related services (the &quot;Service&quot;). Your use of the Service is also governed by our <Link href="/privacy" className="text-accent underline hover:text-indigo">Privacy Policy</Link>, which is incorporated into these Terms by reference.</p>
                </section>

                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">2. Eligibility &amp; account</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">3. Wellness only — no medical advice; not for emergencies</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">4. Data protection</h2>
                  <p className="mb-3">We implement reasonable security measures to protect your personal data. Full details on data categories, collection methods, uses, sharing, retention, and your rights are set out in our <Link href="/privacy" className="text-accent underline hover:text-indigo">Privacy Policy</Link>, which is incorporated into these Terms by reference.</p>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">5. Organization/Team spaces</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">6. Acceptable use</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">7. Intellectual property &amp; license</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">8. Feedback</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">9. Beta features</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">10. Subscriptions, trials, and refunds</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">11. Third-party services &amp; hardware</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">12. Disclaimers</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">13. Assumption of risk &amp; release</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">14. Indemnification</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">15. Limitation of liability</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">16. Governing law &amp; dispute resolution</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">17. Changes to the Service and Terms</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">18. Termination</h2>
                ...
                <section>
                  <h2 className="t90 font-black text-2xl md:text-3xl text-cobalt mb-3">19. Contact</h2>
                  <p>
                    Jeani Inc.<br />
